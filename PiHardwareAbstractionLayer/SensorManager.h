	...
	protected:
		...
		*/
		...
		std::map<SensorType, std::vector<SensorName>> m_concrete_sensors = {
			...
			{SensorType::CARBON_DIOXIDE_CO2, {SensorName::CCS811}},
			{SensorType::TVOC, {SensorName::CCS811}},
			{SensorType::CARBON_MONOXIDE_CO, {SensorName::MICS6814}},
			{SensorType::NITROGEN_DIOXIDE_NO2, {SensorName::MICS6814}},
			{SensorType::AMMONIAC_NH3, {SensorName::MICS6814}},
			{SensorType::PROPANE_C3H8, {SensorName::MICS6814}},
			{SensorType::BUTANE_C4H10, {SensorName::MICS6814}},
			{SensorType::METHANE_CH4, {SensorName::MICS6814}},
			{SensorType::HYDROGEN_H2, {SensorName::MICS6814}},
			{SensorType::ETHANOL_C2H5OH, {SensorName::MICS6814}},
