...
void db_manager::add_sensor_entry(dto::sensor_dto* new_value)
{
	if (new_value == nullptr)
	{
		handle_error("add_sensor_entry", tables["sensors"]->get_table_name(), "Input param is NULL", "Null Pointer Exception: Param 'value' is NULL");
	}
	...
	{
		handle_error("add_sensor_entry", tables["sensors"]->get_table_name(), add_sensors_value.c_str(), mysql_error(db_connection));
	}
}

void db_manager::delete_sensor_entry(dto::sensor_dto* value)
{
	if (value == nullptr)
	{
...
void db_manager::delete_sensor_entry(std::string sensor_type_name, std::string individual_name, std::chrono::time_point<std::chrono::system_clock> timestamp)
{
	std::string statement = "DELETE FROM " + std::string(tables["sensors"]->get_table_name()) +
...
void db_manager::delete_sensor_entries(std::string sensor_type_name, std::string individual_name)
{
	std::string statement = "DELETE FROM " + std::string(tables["sensors"]->get_table_name()) +
		" WHERE sensor_type_name='" + sensor_type_name + "' AND individual_name='" + individual_name + "';";
...
void db_manager::delete_sensor_entries(std::string sensor_type_name, std::string individual_name, std::chrono::time_point<std::chrono::system_clock> timestamp, bool delete_older)
{
	std::string statement = "DELETE FROM " + std::string(tables["sensors"]->get_table_name()) +
		" WHERE sensor_type_name='" + sensor_type_name + "' AND individual_name='" + individual_name +
...
void db_manager::update_entry(std::string sensor_type_name, std::string individual_name, std::string column, std::string old_value, std::string new_value)
{
...
void db_manager::update_entry(std::string sensor_type_name, std::string individual_name, std::string column, int old_value, int new_value)
{
...
void db_manager::update_entry(std::string sensor_type_name, std::string individual_name, std::string column, float old_value, float new_value)
{
	std::string statement = "UPDATE " + std::string(tables["sensors"]->get_table_name()) + " SET " + column + "=" + std::to_string(new_value) + "" +
		" WHERE sensor_type_name='" + sensor_type_name + "' AND individual_name='" + individual_name + "' AND " + column + "='" + std::to_string(old_value) + "';";
	if (mysql_query(db_connection, statement.c_str()) != 0)
...
void db_manager::update_entry(std::string sensor_type_name, std::string individual_name, std::string column, double old_value, double new_value)
{
	std::string statement = "UPDATE " + std::string(tables["sensors"]->get_table_name()) + " SET " + column + "=" + std::to_string(new_value) + "" +
		" WHERE sensor_type_name='" + sensor_type_name + "' AND individual_name='" + individual_name + "' AND " + column + "='" + std::to_string(old_value) + "';";
	if (mysql_query(db_connection, statement.c_str()) != 0)
...
void db_manager::update_entry(std::string sensor_type_name, std::string individual_name, std::string column, bool old_value, bool new_value)
{
...
dto::sensor_dto* db_manager::get_sensor_entry(dto::sensor_dto* value)
{
	if (value == nullptr)
	{
	...
	return get_single_sensor_query_result(statement.c_str());
}

dto::sensor_dto* db_manager::get_sensor_entry(std::string sensor_type_name, std::string individual_name, std::chrono::time_point<std::chrono::system_clock> timestamp)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
		" WHERE sensor_type_name='" + sensor_type_name + "' AND individual_name='" + individual_name + 
		"' AND timestamp=STR_TO_DATE('" + utils::time_converter::timepoint_to_string(timestamp) + "', '" + utils::time_converter::default_time_format + "');";
...
std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries()
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name());

	return get_multiple_sensor_query_results(statement.c_str());
}

std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries(std::string sensor_type_name)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
...
std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries(std::string sensor_type_name, std::string individual_name)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
		" WHERE sensor_type_name='" + sensor_type_name + "' AND individual_name='" + individual_name + "';";
...
std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries(std::chrono::time_point<std::chrono::system_clock> timestamp, bool older_entries)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
...
std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries(std::chrono::time_point<std::chrono::system_clock> start_timestamp, std::chrono::time_point<std::chrono::system_clock> end_timestamp)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
...
std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries(std::string sensor_type_name, std::chrono::time_point<std::chrono::system_clock> timestamp, bool older_entries)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
		" WHERE sensor_type_name='" + sensor_type_name + 
...
std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries(std::string sensor_type_name, std::chrono::time_point<std::chrono::system_clock> start_timestamp, std::chrono::time_point<std::chrono::system_clock> end_timestamp)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
		" WHERE sensor_type_name='" + sensor_type_name +
...
std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries(std::string sensor_type_name, std::string individual_name, std::chrono::time_point<std::chrono::system_clock> timestamp, bool older_entries)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
		" WHERE sensor_type_name='" + sensor_type_name + 
...
std::vector<dto::sensor_dto*> db_manager::get_all_sensor_entries(std::string sensor_type_name, std::string individual_name, std::chrono::time_point<std::chrono::system_clock> start_timestamp, std::chrono::time_point<std::chrono::system_clock> end_timestamp)
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
		" WHERE sensor_type_name='" + sensor_type_name +
		"' AND individual_name = '" + individual_name +
...
dto::sensor_dto* db_manager::get_first_sensor_entry()
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
		" LIMIT 1;";
...
dto::sensor_dto* db_manager::get_last_sensor_entry()
{
	std::string statement = "SELECT * FROM " + std::string(tables["sensors"]->get_table_name()) +
...
dto::sensor_dto* db_manager::get_single_sensor_query_result(const char* statement)
{
	if (mysql_query(db_connection, statement) != 0)
	{
		handle_error("get_single_sensor_query_result", tables["sensors"]->get_table_name(), statement, mysql_error(db_connection));
	}

	dto::sensor_dto* entry = new dto::sensor_dto();
	...
	if (row != NULL)
	{
		...
		entry->set_timestamp(row[3]);
		entry->set_value(atof(row[4]));
	}
...
std::vector<dto::sensor_dto*> db_manager::get_multiple_sensor_query_results(const char* statement)
{
	if (mysql_query(db_connection, statement) != 0)
	{
	...
	std::vector<dto::sensor_dto*> entries;
	MYSQL_RES* result = mysql_use_result(db_connection);
	MYSQL_ROW row;
	...
	if (result)
	{
		...
		{
			// row[0] = id
			entries.push_back(new dto::sensor_dto(row[1], row[2], row[2], utils::time_converter::default_time_format, atof(row[3])));
		}
	}
