...
namespace dto
{
	...
	public:
		...
		void set_timestamp(std::chrono::time_point<std::chrono::system_clock> new_timestamp) { m_timestamp = new_timestamp; }

		void set_timestamp(std::string new_timestamp) { m_timestamp = utils::time_converter::string_to_timepoint(new_timestamp); }

		void set_timestamp(std::string new_timestamp, std::string time_format) { m_timestamp = utils::time_converter::string_to_timepoint(new_timestamp, time_format); }
		...
		std::chrono::time_point<std::chrono::system_clock> get_timestamp_as_chrono() const { return m_timestamp; }

		std::string get_timestamp_as_string() const { return utils::time_converter::timepoint_to_string(m_timestamp); }
